-- ============================================================
-- Aniekan Israel — reset from the old SwiftCreator schema
-- ============================================================
-- Run this INSTEAD of 0001 if the project already has the old
-- SwiftCreator tables (symptom: `column "published" does not exist`).
--
-- ⚠️  DESTRUCTIVE: drops the old projects / inquiries / testimonials /
--     pricing_tiers tables and recreates them in the new schema.
--     Only the earlier SwiftCreator seed/test data is lost.
--     Existing Auth users are preserved (profiles are backfilled).
-- Safe to re-run.
-- ============================================================
...
-- profiles kept if present; recreated below if missing.
...
-- ============================================================
-- Next: create your admin user in Supabase Auth, then:
--   update public.profiles set is_admin = true where email = 'aniekaneazy@gmail.com';
-- ============================================================
